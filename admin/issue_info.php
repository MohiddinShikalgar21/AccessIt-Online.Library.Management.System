...
function closeNav() {
  ...
  <div class="container">
    ...
    $c=0;
      ...
      if(isset($_SESSION['login_user']))
      {
        $sql="SELECT user.username,books.id,name,authors,edition,issue_book.approve,`return`,issue FROM user inner join issue_book ON user.username=issue_book.username inner join books ON issue_book.bid=books.id WHERE issue_book.approve ='Yes' ORDER BY `issue_book`.`return` ASC";
